...
use embedded_graphics::{pixelcolor::raw::RawU4, prelude::*, primitives::Rectangle};
use ra_fsp_sys::generated::{display_event_t, display_frame_layer_t, e_display_event};
...
impl Display {
    pub fn new(
        ...
        assert_eq!(bpp(input.format) as usize, BPP);
        ...
        Ok(Self {
            ...
            hstride_bytes: input.hstride as usize * BPP / 8,
            filter,
            layer,
            synchronizer_rx,
            // counter: &synchronizer.1,
...
impl<'a, 'b> DrawTarget for Display {
