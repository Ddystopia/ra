///Register `TCON_STH%s2` reader
pub type R = crate::R<TCON_STH2_SPEC>;
///Register `TCON_STH%s2` writer
pub type W = crate::W<TCON_STH2_SPEC>;
/**Output signal select control for LCD_TCON2 (controlled by TCON_STHA2 register)/LCD_TCON3 (controlled by the TCON_STHB2 register) pin.
...
///Field `SEL` reader - Output signal select control for LCD_TCON2 (controlled by TCON_STHA2 register)/LCD_TCON3 (controlled by the TCON_STHB2 register) pin.
...
///Field `SEL` writer - Output signal select control for LCD_TCON2 (controlled by TCON_STHA2 register)/LCD_TCON3 (controlled by the TCON_STHB2 register) pin.
...
/**STHx signal generation reference timing control.

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum HSSEL_A {
    ///1: Reference timing is the offset set with the TCON_TIM.OFFSET\[10:0\] (horizontal synchronization generation reference timing) field
    _1 = 1,
    ///0: Reference timing is the input horizontal synchronization signal (HSIN)
    _0 = 0,
}
...
///Field `HSSEL` reader - STHx signal generation reference timing control.
pub type HSSEL_R = crate::BitReader<HSSEL_A>;
impl HSSEL_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> HSSEL_A {
        match self.bits {
            true => HSSEL_A::_1,
            false => HSSEL_A::_0,
        }
    }
    ///Reference timing is the offset set with the TCON_TIM.OFFSET\[10:0\] (horizontal synchronization generation reference timing) field
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == HSSEL_A::_1
    }
    ///Reference timing is the input horizontal synchronization signal (HSIN)
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == HSSEL_A::_0
    }
}
///Field `HSSEL` writer - STHx signal generation reference timing control.
pub type HSSEL_W<'a, REG> = crate::BitWriter<'a, REG, HSSEL_A>;
impl<'a, REG> HSSEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Reference timing is the offset set with the TCON_TIM.OFFSET\[10:0\] (horizontal synchronization generation reference timing) field
...
You can [`read`](crate::Reg::read) this register and get [`tcon_sth2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tcon_sth2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct TCON_STH2_SPEC;
impl crate::RegisterSpec for TCON_STH2_SPEC {
    type Ux = u32;
}
///`read()` method returns [`tcon_sth2::R`](R) reader structure
impl crate::Readable for TCON_STH2_SPEC {}
///`write(|w| ..)` method takes [`tcon_sth2::W`](W) writer structure
impl crate::Writable for TCON_STH2_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets TCON_STH%s2 to value 0
