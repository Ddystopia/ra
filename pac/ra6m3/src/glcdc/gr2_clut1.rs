///Register `GR2_CLUT1[%s]` reader
pub type R = crate::R<GR2_CLUT1_SPEC>;
///Register `GR2_CLUT1[%s]` writer
pub type W = crate::W<GR2_CLUT1_SPEC>;
...
impl W {
    ///Bits 0:7 - B Value of Color Palette n Plane for Graphics m Plane
    #[inline(always)]
    pub fn b(&mut self) -> B_W<'_, GR2_CLUT1_SPEC> {
        B_W::new(self, 0)
    }
    ///Bits 8:15 - G Value of Color Palette n Plane for Graphics m Plane
    #[inline(always)]
    pub fn g(&mut self) -> G_W<'_, GR2_CLUT1_SPEC> {
        G_W::new(self, 8)
    }
    ///Bits 16:23 - R Value of Color Palette n Plane for Graphics m Plane
    #[inline(always)]
    pub fn r(&mut self) -> R_W<'_, GR2_CLUT1_SPEC> {
        R_W::new(self, 16)
    }
    ///Bits 24:31 - Alpha Blending Value of Color Palette n Plane for Graphics m Plane
    #[inline(always)]
    pub fn a(&mut self) -> A_W<'_, GR2_CLUT1_SPEC> {
        A_W::new(self, 24)
    }
}
/**Color Palette 1 Plane for Graphics 2 Plane

You can [`read`](crate::Reg::read) this register and get [`gr2_clut1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gr2_clut1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct GR2_CLUT1_SPEC;
impl crate::RegisterSpec for GR2_CLUT1_SPEC {
    type Ux = u32;
}
///`read()` method returns [`gr2_clut1::R`](R) reader structure
impl crate::Readable for GR2_CLUT1_SPEC {}
///`write(|w| ..)` method takes [`gr2_clut1::W`](W) writer structure
impl crate::Writable for GR2_CLUT1_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets GR2_CLUT1[%s] to value 0
