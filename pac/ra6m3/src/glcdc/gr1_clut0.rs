///Register `GR1_CLUT0[%s]` reader
pub type R = crate::R<GR1_CLUT0_SPEC>;
///Register `GR1_CLUT0[%s]` writer
pub type W = crate::W<GR1_CLUT0_SPEC>;
...
You can [`read`](crate::Reg::read) this register and get [`gr1_clut0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gr1_clut0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct GR1_CLUT0_SPEC;
impl crate::RegisterSpec for GR1_CLUT0_SPEC {
    type Ux = u32;
}
///`read()` method returns [`gr1_clut0::R`](R) reader structure
impl crate::Readable for GR1_CLUT0_SPEC {}
///`write(|w| ..)` method takes [`gr1_clut0::W`](W) writer structure
impl crate::Writable for GR1_CLUT0_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets GR1_CLUT0[%s] to value 0
