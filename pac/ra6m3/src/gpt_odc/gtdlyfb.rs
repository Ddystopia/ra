///Register `GTDLYF%sB` reader
pub type R = crate::R<GTDLYFB_SPEC>;
///Register `GTDLYF%sB` writer
pub type W = crate::W<GTDLYFB_SPEC>;
...
///Field `DLY` reader - GTIOCnB Output Falling Edge Delay Setting
...
///Field `DLY` writer - GTIOCnB Output Falling Edge Delay Setting
...
impl R {
    ///Bits 0:4 - GTIOCnB Output Falling Edge Delay Setting
    #[inline(always)]
...
impl W {
    ///Bits 0:4 - GTIOCnB Output Falling Edge Delay Setting
    #[inline(always)]
    pub fn dly(&mut self) -> DLY_W<'_, GTDLYFB_SPEC> {
        DLY_W::new(self, 0)
    }
}
/**GTIOC%sB Falling Output Delay Register

You can [`read`](crate::Reg::read) this register and get [`gtdlyfb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gtdlyfb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct GTDLYFB_SPEC;
impl crate::RegisterSpec for GTDLYFB_SPEC {
    type Ux = u16;
}
///`read()` method returns [`gtdlyfb::R`](R) reader structure
impl crate::Readable for GTDLYFB_SPEC {}
///`write(|w| ..)` method takes [`gtdlyfb::W`](W) writer structure
impl crate::Writable for GTDLYFB_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets GTDLYF%sB to value 0
