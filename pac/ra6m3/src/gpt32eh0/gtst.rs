...
pub type TCFPO_W<'a, REG> = crate::BitWriter<'a, REG, TCFPO_A>;
impl<'a, REG> TCFPO_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///No overflow (crest) has occurred.
...
///Field `ITCNT` reader - GTCIV/GTCIU Interrupt Skipping Count Counter(Counter for counting the number of times a timer interrupt has been skipped.)
pub type ITCNT_R = crate::FieldReader;
...
///Field `DTEF` reader - Dead Time Error Flag
...
impl R {
    ...
    ///Bits 8:10 - GTCIV/GTCIU Interrupt Skipping Count Counter(Counter for counting the number of times a timer interrupt has been skipped.)
    #[inline(always)]
