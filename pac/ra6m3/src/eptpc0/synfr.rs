///Register `SYNFR` reader
pub type R = crate::R<SYNFR_SPEC>;
///Register `SYNFR` writer
pub type W = crate::W<SYNFR_SPEC>;
/**alternateMasterFlag
...
///Field `FLAG9` reader - twoStepFlag
...
///Field `FLAG9` writer - twoStepFlag
...
impl W {
    ///Bit 8 - alternateMasterFlag
    #[inline(always)]
    pub fn flag8(&mut self) -> FLAG8_W<'_, SYNFR_SPEC> {
        FLAG8_W::new(self, 8)
    }
    ///Bit 9 - twoStepFlag
    #[inline(always)]
    pub fn flag9(&mut self) -> FLAG9_W<'_, SYNFR_SPEC> {
        FLAG9_W::new(self, 9)
    }
    ///Bit 10 - unicastFlag
    #[inline(always)]
    pub fn flag10(&mut self) -> FLAG10_W<'_, SYNFR_SPEC> {
        FLAG10_W::new(self, 10)
    }
    ///Bit 13 - PTP profile Specific 1
    #[inline(always)]
    pub fn flag13(&mut self) -> FLAG13_W<'_, SYNFR_SPEC> {
        FLAG13_W::new(self, 13)
    }
    ///Bit 14 - PTP profile Specific 2
    #[inline(always)]
    pub fn flag14(&mut self) -> FLAG14_W<'_, SYNFR_SPEC> {
        FLAG14_W::new(self, 14)
    }
}
/**Sync Message Flag Field Setting Register

You can [`read`](crate::Reg::read) this register and get [`synfr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`synfr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SYNFR_SPEC;
impl crate::RegisterSpec for SYNFR_SPEC {
    type Ux = u32;
}
///`read()` method returns [`synfr::R`](R) reader structure
impl crate::Readable for SYNFR_SPEC {}
///`write(|w| ..)` method takes [`synfr::W`](W) writer structure
impl crate::Writable for SYNFR_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SYNFR to value 0
