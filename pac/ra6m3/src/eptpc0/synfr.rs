...
impl W {
    ///Bit 8 - alternateMasterFlag
    #[inline(always)]
    pub fn flag8(&mut self) -> FLAG8_W<SYNFR_SPEC> {
        FLAG8_W::new(self, 8)
    }
    ///Bit 9 - twoStepFlag
    #[inline(always)]
    pub fn flag9(&mut self) -> FLAG9_W<SYNFR_SPEC> {
        FLAG9_W::new(self, 9)
    }
    ///Bit 10 - unicastFlag
    #[inline(always)]
    pub fn flag10(&mut self) -> FLAG10_W<SYNFR_SPEC> {
        FLAG10_W::new(self, 10)
    }
    ///Bit 13 - PTP profile Specific 1
    #[inline(always)]
    pub fn flag13(&mut self) -> FLAG13_W<SYNFR_SPEC> {
        FLAG13_W::new(self, 13)
    }
    ///Bit 14 - PTP profile Specific 2
    #[inline(always)]
    pub fn flag14(&mut self) -> FLAG14_W<SYNFR_SPEC> {
