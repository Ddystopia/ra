...
impl RegisterBlock {
    ...
    ///0xe0..0xe8 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )
    #[inline(always)]
...
pub mod adsstro;
/**ADSSTR0 (rw) register accessor: A/D Sampling State Register %s (Corresponding Channel is AN00%s )
