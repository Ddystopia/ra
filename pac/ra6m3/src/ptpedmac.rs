...
impl RegisterBlock {
    ...
    ///0x28 - PTP/EDMAC Status Register
    #[inline(always)]
    pub const fn eesr(&self) -> &EESR {
        &self.eesr
    }
    ///0x30 - PTP/EDMAC Status Interrupt Enable Register
    #[inline(always)]
...
/**EDMR (rw) register accessor: PTPEDMAC Mode Register
...
pub mod rdlar;
/**EESR (rw) register accessor: PTP/EDMAC Status Register
...
pub mod eesr;
/**EESIPR (rw) register accessor: PTP/EDMAC Status Interrupt Enable Register
