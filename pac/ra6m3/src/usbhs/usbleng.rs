...
///Field `WLENGTH` reader - Value of USB request wLength Finction controller selected : read-only Host controller selected : read-write
pub type WLENGTH_R = crate::FieldReader<u16>;
///Field `WLENGTH` writer - Value of USB request wLength Finction controller selected : read-only Host controller selected : read-write
