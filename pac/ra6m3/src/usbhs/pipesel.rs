...
/**Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH.
...
///Field `PIPESEL` reader - Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH.
...
///Field `PIPESEL` writer - Pipe Window SelectThese bits specify the pipe for registers at addresses 68H to 6EH.
