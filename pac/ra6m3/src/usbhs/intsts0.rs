...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBSTS_A {
    ///0: The USBHS_VBUS pin is low
    _0 = 0,
    ///1: The USBHS_VBUS pin is high
    _1 = 1,
}
...
pub enum BEMP_A {
    ...
    _0 = 0,
    ///1: BEMP interrupts are not generated
    _1 = 1,
}
...
pub type CTRT_W<'a, REG> = crate::BitWriter<'a, REG, CTRT_A>;
...
pub type DVST_W<'a, REG> = crate::BitWriter<'a, REG, DVST_A>;
...
pub type SOFR_W<'a, REG> = crate::BitWriter<'a, REG, SOFR_A>;
...
pub type RESM_W<'a, REG> = crate::BitWriter<'a, REG, RESM_A>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VBINT_A {
    ///0: VBUS interrupt is not generated on detecting a change in the USBHS_VBUS pin.
    _0 = 0,
    ///1: VBUS interrupt is generated on detecting a change in the USBHS_VBUS pin.
    _1 = 1,
}
...
pub type VBINT_W<'a, REG> = crate::BitWriter<'a, REG, VBINT_A>;
