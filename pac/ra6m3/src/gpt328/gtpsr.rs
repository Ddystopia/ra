...
pub enum PSELCH_A {
    ...
    _0 = 0,
    ///1: Enable counter stop on ELCH event inpu
    _1 = 1,
}
...
impl W {
    ...
    ///Bit 4 - GTETRGC Pin Rising Input Source Counter Stop Enable
    #[inline(always)]
    pub fn psgtrgcr(&mut self) -> PSGTRGCR_W<'_, GTPSR_SPEC> {
        PSGTRGCR_W::new(self, 4)
    }
    ///Bit 5 - GTETRGC Pin Falling Input Source Counter Stop Enable
    #[inline(always)]
    pub fn psgtrgcf(&mut self) -> PSGTRGCF_W<'_, GTPSR_SPEC> {
        PSGTRGCF_W::new(self, 5)
    }
    ///Bit 6 - GTETRGD Pin Rising Input Source Counter Stop Enable
    #[inline(always)]
    pub fn psgtrgdr(&mut self) -> PSGTRGDR_W<'_, GTPSR_SPEC> {
        PSGTRGDR_W::new(self, 6)
    }
    ///Bit 7 - GTETRGD Pin Falling Input Source Counter Stop Enable
    #[inline(always)]
    pub fn psgtrgdf(&mut self) -> PSGTRGDF_W<'_, GTPSR_SPEC> {
