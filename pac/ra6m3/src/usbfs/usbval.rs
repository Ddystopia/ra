...
///Field `WVALUE` reader - ValueThese bits store the USB request wValue value.
pub type WVALUE_R = crate::FieldReader<u16>;
///Field `WVALUE` writer - ValueThese bits store the USB request wValue value.
pub type WVALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    ///Bits 0:15 - ValueThese bits store the USB request wValue value.
    #[inline(always)]
