...
/**Protection of register (PSPMPUAC, PSPMPUSA and PSPMPUSE)
...
///Field `PROTECT` reader - Protection of register (PSPMPUAC, PSPMPUSA and PSPMPUSE)
...
///Field `PROTECT` writer - Protection of register (PSPMPUAC, PSPMPUSA and PSPMPUSE)
...
impl R {
    ///Bit 0 - Protection of register (PSPMPUAC, PSPMPUSA and PSPMPUSE)
    #[inline(always)]
