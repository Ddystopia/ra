...
///Field `SHANS0` reader - AN000 sample-and-hold circuit Select
...
///Field `SHANS0` writer - AN000 sample-and-hold circuit Select
...
///Field `SHANS1` reader - AN001 sample-and-hold circuit Select
...
///Field `SHANS1` writer - AN001 sample-and-hold circuit Select
...
///Field `SHANS2` reader - AN002 sample-and-hold circuit Select
...
///Field `SHANS2` writer - AN002 sample-and-hold circuit Select
...
impl R {
    ...
    ///Bit 8 - AN000 sample-and-hold circuit Select
    #[inline(always)]
    pub fn shans0(&self) -> SHANS0_R {
        SHANS0_R::new(((self.bits >> 8) & 1) != 0)
    }
    ///Bit 9 - AN001 sample-and-hold circuit Select
    #[inline(always)]
    pub fn shans1(&self) -> SHANS1_R {
        SHANS1_R::new(((self.bits >> 9) & 1) != 0)
    }
    ///Bit 10 - AN002 sample-and-hold circuit Select
    #[inline(always)]
