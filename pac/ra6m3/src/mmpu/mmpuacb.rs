///Register `MMPUACB%s` reader
pub type R = crate::R<MMPUACB_SPEC>;
///Register `MMPUACB%s` writer
pub type W = crate::W<MMPUACB_SPEC>;
/**Region enable
...
You can [`read`](crate::Reg::read) this register and get [`mmpuacb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mmpuacb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MMPUACB_SPEC;
impl crate::RegisterSpec for MMPUACB_SPEC {
    type Ux = u16;
}
///`read()` method returns [`mmpuacb::R`](R) reader structure
impl crate::Readable for MMPUACB_SPEC {}
///`write(|w| ..)` method takes [`mmpuacb::W`](W) writer structure
impl crate::Writable for MMPUACB_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MMPUACB%s to value 0
