///Register `MMPUPTC` reader
pub type R = crate::R<MMPUPTC_SPEC>;
///Register `MMPUPTC` writer
pub type W = crate::W<MMPUPTC_SPEC>;
/**Protection of register (MMPUSCn, MMPUECn and MMPUACCn)

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PROTECT_A {
    ///0: All Bus Master MPU Group C register writing is possible.
    _0 = 0,
    ///1: All Bus Master MPU Group C register writing is protected. Read is possible.
    _1 = 1,
}
...
///Field `PROTECT` reader - Protection of register (MMPUSCn, MMPUECn and MMPUACCn)
...
///Field `PROTECT` writer - Protection of register (MMPUSCn, MMPUECn and MMPUACCn)
...
impl R {
    ///Bit 0 - Protection of register (MMPUSCn, MMPUECn and MMPUACCn)
    #[inline(always)]
...
impl W {
    ///Bit 0 - Protection of register (MMPUSCn, MMPUECn and MMPUACCn)
    #[inline(always)]
    pub fn protect(&mut self) -> PROTECT_W<'_, MMPUPTC_SPEC> {
        PROTECT_W::new(self, 0)
    }
    ///Bits 8:15 - Write Keyword The data written to these bits are not stored.
    #[inline(always)]
    pub fn key(&mut self) -> KEY_W<'_, MMPUPTC_SPEC> {
        KEY_W::new(self, 8)
    }
}
/**Group C protection of register

You can [`read`](crate::Reg::read) this register and get [`mmpuptc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mmpuptc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MMPUPTC_SPEC;
impl crate::RegisterSpec for MMPUPTC_SPEC {
    type Ux = u16;
}
///`read()` method returns [`mmpuptc::R`](R) reader structure
impl crate::Readable for MMPUPTC_SPEC {}
///`write(|w| ..)` method takes [`mmpuptc::W`](W) writer structure
impl crate::Writable for MMPUPTC_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MMPUPTC to value 0
