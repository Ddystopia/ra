///Register `MMPUACC%s` reader
pub type R = crate::R<MMPUACC_SPEC>;
///Register `MMPUACC%s` writer
pub type W = crate::W<MMPUACC_SPEC>;
/**Region enable
...
impl W {
    ///Bit 0 - Region enable
    #[inline(always)]
    pub fn enable(&mut self) -> ENABLE_W<'_, MMPUACC_SPEC> {
        ENABLE_W::new(self, 0)
    }
    ///Bit 1 - Read protection
    #[inline(always)]
    pub fn rp(&mut self) -> RP_W<'_, MMPUACC_SPEC> {
        RP_W::new(self, 1)
    }
    ///Bit 2 - Write protection
    #[inline(always)]
    pub fn wp(&mut self) -> WP_W<'_, MMPUACC_SPEC> {
        WP_W::new(self, 2)
    }
}
/**Group C Region %s Access Control Register

You can [`read`](crate::Reg::read) this register and get [`mmpuacc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mmpuacc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct MMPUACC_SPEC;
impl crate::RegisterSpec for MMPUACC_SPEC {
    type Ux = u16;
}
///`read()` method returns [`mmpuacc::R`](R) reader structure
impl crate::Readable for MMPUACC_SPEC {}
///`write(|w| ..)` method takes [`mmpuacc::W`](W) writer structure
impl crate::Writable for MMPUACC_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets MMPUACC%s to value 0
