///Register `MMPUPTA` reader
pub type R = crate::R<MMPUPTA_SPEC>;
///Register `MMPUPTA` writer
...
pub enum PROTECT_A {
    ///0: All Bus Master MPU Group A register writing is possible.
    _0 = 0,
    ///1: All Bus Master MPU Group A register writing is protected. Read is possible.
    _1 = 1,
}
...
///Field `PROTECT` reader - Protection of register(MMPUSAn, MMPUEAn and MMPUACAn)
...
///Field `PROTECT` writer - Protection of register(MMPUSAn, MMPUEAn and MMPUACAn)
...
impl R {
    ///Bit 0 - Protection of register(MMPUSAn, MMPUEAn and MMPUACAn)
    #[inline(always)]
...
///`read()` method returns [`mmpupta::R`](R) reader structure
impl crate::Readable for MMPUPTA_SPEC {}
///`write(|w| ..)` method takes [`mmpupta::W`](W) writer structure
