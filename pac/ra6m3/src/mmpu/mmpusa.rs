///Register `MMPUSA%s` reader
pub type R = crate::R<MMPUSA_SPEC>;
///Register `MMPUSA%s` writer
pub type W = crate::W<MMPUSA_SPEC>;
///Field `MMPUSA` reader - Address where the region starts, for use in region determination.NOTE: The low-order 2 bits are fixed to 0.
pub type MMPUSA_R = crate::FieldReader<u32>;
///Field `MMPUSA` writer - Address where the region starts, for use in region determination.NOTE: The low-order 2 bits are fixed to 0.
pub type MMPUSA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
///`read()` method returns [`mmpusa::R`](R) reader structure
impl crate::Readable for MMPUSA_SPEC {}
///`write(|w| ..)` method takes [`mmpusa::W`](W) writer structure
