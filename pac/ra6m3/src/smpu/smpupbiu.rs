///Register `SMPUP%sBIU` reader
pub type R = crate::R<SMPUPBIU_SPEC>;
///Register `SMPUP%sBIU` writer
...
pub enum RP_GRPB_A {
    ...
    _0 = 0,
    ///1: Master group B read of memory protection is enabled. The write value should always be 1.
    _1 = 1,
}
...
pub enum WP_GRPB_A {
    ///0: Setting prohibited
    _0 = 0,
    ///1: Master group B write of memory protection is enabled. The write value should always be 1.
    _1 = 1,
}
...
impl W {
    ///Bit 0 - CPU Read protection
    #[inline(always)]
    pub fn rp_cpu(&mut self) -> RP_CPU_W<'_, SMPUPBIU_SPEC> {
        RP_CPU_W::new(self, 0)
    }
    ///Bit 1 - CPU Write protection
    #[inline(always)]
    pub fn wp_cpu(&mut self) -> WP_CPU_W<'_, SMPUPBIU_SPEC> {
        WP_CPU_W::new(self, 1)
    }
    ///Bit 2 - Master Group A Read protection
    #[inline(always)]
    pub fn rp_grpa(&mut self) -> RP_GRPA_W<'_, SMPUPBIU_SPEC> {
        RP_GRPA_W::new(self, 2)
    }
    ///Bit 3 - Master Group A Write protection
    #[inline(always)]
    pub fn wp_grpa(&mut self) -> WP_GRPA_W<'_, SMPUPBIU_SPEC> {
        WP_GRPA_W::new(self, 3)
    }
    ///Bit 4 - Master Group B Read protection
    #[inline(always)]
    pub fn rp_grpb(&mut self) -> RP_GRPB_W<'_, SMPUPBIU_SPEC> {
        RP_GRPB_W::new(self, 4)
    }
    ///Bit 5 - Master Group B Write protection
    #[inline(always)]
    pub fn wp_grpb(&mut self) -> WP_GRPB_W<'_, SMPUPBIU_SPEC> {
        WP_GRPB_W::new(self, 5)
    }
    ///Bit 6 - Master Group C Read protection
    #[inline(always)]
    pub fn rp_grpc(&mut self) -> RP_GRPC_W<'_, SMPUPBIU_SPEC> {
        RP_GRPC_W::new(self, 6)
    }
    ///Bit 7 - Master Group C Write protection
    #[inline(always)]
    pub fn wp_grpc(&mut self) -> WP_GRPC_W<'_, SMPUPBIU_SPEC> {
...
///`read()` method returns [`smpupbiu::R`](R) reader structure
impl crate::Readable for SMPUPBIU_SPEC {}
///`write(|w| ..)` method takes [`smpupbiu::W`](W) writer structure
impl crate::Writable for SMPUPBIU_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SMPUP%sBIU to value 0xf0
impl crate::Resettable for SMPUPBIU_SPEC {
    const RESET_VALUE: u16 = 0xf0;
}
