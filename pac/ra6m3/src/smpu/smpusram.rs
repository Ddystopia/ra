///Register `SMPUSRAM%s` reader
pub type R = crate::R<SMPUSRAM_SPEC>;
///Register `SMPUSRAM%s` writer
pub type W = crate::W<SMPUSRAM_SPEC>;
/**CPU Read protection
...
impl W {
    ///Bit 0 - CPU Read protection
    #[inline(always)]
    pub fn rp_cpu(&mut self) -> RP_CPU_W<'_, SMPUSRAM_SPEC> {
        RP_CPU_W::new(self, 0)
    }
    ///Bit 1 - CPU Write protection
    #[inline(always)]
    pub fn wp_cpu(&mut self) -> WP_CPU_W<'_, SMPUSRAM_SPEC> {
        WP_CPU_W::new(self, 1)
    }
    ///Bit 2 - Master Group A Read protection
    #[inline(always)]
    pub fn rp_grpa(&mut self) -> RP_GRPA_W<'_, SMPUSRAM_SPEC> {
        RP_GRPA_W::new(self, 2)
    }
    ///Bit 3 - Master Group A Write protection
    #[inline(always)]
    pub fn wp_grpa(&mut self) -> WP_GRPA_W<'_, SMPUSRAM_SPEC> {
        WP_GRPA_W::new(self, 3)
    }
    ///Bit 4 - Master Group B Read protection
    #[inline(always)]
    pub fn rp_grpb(&mut self) -> RP_GRPB_W<'_, SMPUSRAM_SPEC> {
        RP_GRPB_W::new(self, 4)
    }
    ///Bit 5 - Master Group B Write protection
    #[inline(always)]
    pub fn wp_grpb(&mut self) -> WP_GRPB_W<'_, SMPUSRAM_SPEC> {
        WP_GRPB_W::new(self, 5)
    }
    ///Bit 6 - Master Group C Read protection
    #[inline(always)]
    pub fn rp_grpc(&mut self) -> RP_GRPC_W<'_, SMPUSRAM_SPEC> {
        RP_GRPC_W::new(self, 6)
    }
    ///Bit 7 - Master Group C Write protection
    #[inline(always)]
    pub fn wp_grpc(&mut self) -> WP_GRPC_W<'_, SMPUSRAM_SPEC> {
        WP_GRPC_W::new(self, 7)
    }
}
/**Access Control Register for SRAM%s

You can [`read`](crate::Reg::read) this register and get [`smpusram::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`smpusram::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SMPUSRAM_SPEC;
impl crate::RegisterSpec for SMPUSRAM_SPEC {
    type Ux = u16;
}
///`read()` method returns [`smpusram::R`](R) reader structure
impl crate::Readable for SMPUSRAM_SPEC {}
///`write(|w| ..)` method takes [`smpusram::W`](W) writer structure
impl crate::Writable for SMPUSRAM_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SMPUSRAM%s to value 0
