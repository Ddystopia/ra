///Register `SMPUEXBIU2` reader
pub type R = crate::R<SMPUEXBIU2_SPEC>;
///Register `SMPUEXBIU2` writer
pub type W = crate::W<SMPUEXBIU2_SPEC>;
/**CPU Read protection
...
You can [`read`](crate::Reg::read) this register and get [`smpuexbiu2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`smpuexbiu2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct SMPUEXBIU2_SPEC;
impl crate::RegisterSpec for SMPUEXBIU2_SPEC {
    type Ux = u16;
}
///`read()` method returns [`smpuexbiu2::R`](R) reader structure
impl crate::Readable for SMPUEXBIU2_SPEC {}
///`write(|w| ..)` method takes [`smpuexbiu2::W`](W) writer structure
impl crate::Writable for SMPUEXBIU2_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SMPUEXBIU2 to value 0
