...
/**Software Reset (The read value is 0.)
...
///Field `SWR` reader - Software Reset (The read value is 0.)
pub type SWR_R = crate::BitReader<SWR_A>;
impl SWR_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> SWR_A {
        match self.bits {
            false => SWR_A::_0,
            true => SWR_A::_1,
        }
...
///Field `SWR` writer - Software Reset (The read value is 0.)
