///Register `P108PFS_BY` reader
pub type R = crate::R<P108PFS_BY_SPEC>;
///Register `P108PFS_BY` writer
...
///`read()` method returns [`p108pfs_by::R`](R) reader structure
impl crate::Readable for P108PFS_BY_SPEC {}
///`write(|w| ..)` method takes [`p108pfs_by::W`](W) writer structure
impl crate::Writable for P108PFS_BY_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P108PFS_BY to value 0x10
