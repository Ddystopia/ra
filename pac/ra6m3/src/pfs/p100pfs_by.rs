///Register `P100PFS_BY` reader
pub type R = crate::R<P100PFS_BY_SPEC>;
///Register `P100PFS_BY` writer
pub type W = crate::W<P100PFS_BY_SPEC>;
/**Port Output Data
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PODR_W<'_, P100PFS_BY_SPEC> {
        PODR_W::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PDR_W<'_, P100PFS_BY_SPEC> {
        PDR_W::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PCR_W<'_, P100PFS_BY_SPEC> {
        PCR_W::new(self, 4)
    }
    ///Bit 6 - N-Channel Open Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NCODR_W<'_, P100PFS_BY_SPEC> {
        NCODR_W::new(self, 6)
    }
}
...
///`read()` method returns [`p100pfs_by::R`](R) reader structure
impl crate::Readable for P100PFS_BY_SPEC {}
///`write(|w| ..)` method takes [`p100pfs_by::W`](W) writer structure
