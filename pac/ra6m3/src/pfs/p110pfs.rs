///Register `P110PFS` reader
pub type R = crate::R<P110PFS_SPEC>;
///Register `P110PFS` writer
pub type W = crate::W<P110PFS_SPEC>;
/**Port Output Data
...
///Field `PSEL` reader - Port Function SelectThese bits select the peripheral function. For individual pin functions, see the MPC table
pub type PSEL_R = crate::FieldReader;
///Field `PSEL` writer - Port Function SelectThese bits select the peripheral function. For individual pin functions, see the MPC table
...
impl R {
    ...
    ///Bits 24:28 - Port Function SelectThese bits select the peripheral function. For individual pin functions, see the MPC table
    #[inline(always)]
...
impl W {
    ///Bit 0 - Port Output Data
    #[inline(always)]
    pub fn podr(&mut self) -> PODR_W<'_, P110PFS_SPEC> {
        PODR_W::new(self, 0)
    }
    ///Bit 2 - Port Direction
    #[inline(always)]
    pub fn pdr(&mut self) -> PDR_W<'_, P110PFS_SPEC> {
        PDR_W::new(self, 2)
    }
    ///Bit 4 - Pull-up Control
    #[inline(always)]
    pub fn pcr(&mut self) -> PCR_W<'_, P110PFS_SPEC> {
        PCR_W::new(self, 4)
    }
    ///Bit 6 - N-Channel Open Drain Control
    #[inline(always)]
    pub fn ncodr(&mut self) -> NCODR_W<'_, P110PFS_SPEC> {
        NCODR_W::new(self, 6)
    }
    ///Bits 10:11 - Drive Strength Control Register
    #[inline(always)]
    pub fn dscr(&mut self) -> DSCR_W<'_, P110PFS_SPEC> {
        DSCR_W::new(self, 10)
    }
    ///Bit 12 - Event on Rising
    #[inline(always)]
    pub fn eor(&mut self) -> EOR_W<'_, P110PFS_SPEC> {
        EOR_W::new(self, 12)
    }
    ///Bit 13 - Event on Falling
    #[inline(always)]
    pub fn eof(&mut self) -> EOF_W<'_, P110PFS_SPEC> {
        EOF_W::new(self, 13)
    }
    ///Bit 14 - IRQ input enable
    #[inline(always)]
    pub fn isel(&mut self) -> ISEL_W<'_, P110PFS_SPEC> {
        ISEL_W::new(self, 14)
    }
    ///Bit 15 - Analog Input enable
    #[inline(always)]
    pub fn asel(&mut self) -> ASEL_W<'_, P110PFS_SPEC> {
        ASEL_W::new(self, 15)
    }
    ///Bit 16 - Port Mode Control
    #[inline(always)]
    pub fn pmr(&mut self) -> PMR_W<'_, P110PFS_SPEC> {
        PMR_W::new(self, 16)
    }
    ///Bits 24:28 - Port Function SelectThese bits select the peripheral function. For individual pin functions, see the MPC table
    #[inline(always)]
    pub fn psel(&mut self) -> PSEL_W<'_, P110PFS_SPEC> {
        PSEL_W::new(self, 24)
    }
}
/**P110 Pin Function Control Register

You can [`read`](crate::Reg::read) this register and get [`p110pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p110pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct P110PFS_SPEC;
impl crate::RegisterSpec for P110PFS_SPEC {
    type Ux = u32;
}
///`read()` method returns [`p110pfs::R`](R) reader structure
impl crate::Readable for P110PFS_SPEC {}
///`write(|w| ..)` method takes [`p110pfs::W`](W) writer structure
impl crate::Writable for P110PFS_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P110PFS to value 0x0001_0010
