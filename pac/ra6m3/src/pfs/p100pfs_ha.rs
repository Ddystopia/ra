///Register `P100PFS_HA` reader
pub type R = crate::R<P100PFS_HA_SPEC>;
///Register `P100PFS_HA` writer
pub type W = crate::W<P100PFS_HA_SPEC>;
/**Port Output Data
...
///`read()` method returns [`p100pfs_ha::R`](R) reader structure
impl crate::Readable for P100PFS_HA_SPEC {}
///`write(|w| ..)` method takes [`p100pfs_ha::W`](W) writer structure
