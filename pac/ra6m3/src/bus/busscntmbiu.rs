///Register `BUSSCNTMBIU` reader
pub type R = crate::R<BUSSCNTMBIU_SPEC>;
///Register `BUSSCNTMBIU` writer
pub type W = crate::W<BUSSCNTMBIU_SPEC>;
...
impl W {
    ///Bits 4:5 - Arbitration MethodSpecify the priority between groups
    #[inline(always)]
    pub fn arbmet(&mut self) -> ARBMET_W<'_, BUSSCNTMBIU_SPEC> {
        ARBMET_W::new(self, 4)
    }
    ///Bit 8 - Early Write ResponseWhether the next write request is accepted or not until a response for the write transaction comes back.
    #[inline(always)]
    pub fn ewres(&mut self) -> EWRES_W<'_, BUSSCNTMBIU_SPEC> {
        EWRES_W::new(self, 8)
    }
}
/**Slave Bus Control Register MBIU

You can [`read`](crate::Reg::read) this register and get [`busscntmbiu::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`busscntmbiu::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct BUSSCNTMBIU_SPEC;
impl crate::RegisterSpec for BUSSCNTMBIU_SPEC {
    type Ux = u16;
}
///`read()` method returns [`busscntmbiu::R`](R) reader structure
impl crate::Readable for BUSSCNTMBIU_SPEC {}
///`write(|w| ..)` method takes [`busscntmbiu::W`](W) writer structure
impl crate::Writable for BUSSCNTMBIU_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets BUSSCNTMBIU to value 0
