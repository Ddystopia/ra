///Register `CS0CR` reader
pub type R = crate::R<CS0CR_SPEC>;
///Register `CS0CR` writer
pub type W = crate::W<CS0CR_SPEC>;
/**Operation Enable
...
impl W {
    ///Bit 0 - Operation Enable
    #[inline(always)]
    pub fn exenb(&mut self) -> EXENB_W<'_, CS0CR_SPEC> {
        EXENB_W::new(self, 0)
    }
    ///Bits 4:5 - External Bus Width Select
    #[inline(always)]
    pub fn bsize(&mut self) -> BSIZE_W<'_, CS0CR_SPEC> {
        BSIZE_W::new(self, 4)
    }
    ///Bit 8 - Endian Mode
    #[inline(always)]
    pub fn emode(&mut self) -> EMODE_W<'_, CS0CR_SPEC> {
        EMODE_W::new(self, 8)
    }
    ///Bit 12 - Address/Data Multiplexed I/O Interface Select
    #[inline(always)]
    pub fn mpxen(&mut self) -> MPXEN_W<'_, CS0CR_SPEC> {
        MPXEN_W::new(self, 12)
    }
}
/**CS0 Control Register

You can [`read`](crate::Reg::read) this register and get [`cs0cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cs0cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).*/
pub struct CS0CR_SPEC;
impl crate::RegisterSpec for CS0CR_SPEC {
    type Ux = u16;
}
///`read()` method returns [`cs0cr::R`](R) reader structure
impl crate::Readable for CS0CR_SPEC {}
///`write(|w| ..)` method takes [`cs0cr::W`](W) writer structure
impl crate::Writable for CS0CR_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets CS0CR to value 0x21
