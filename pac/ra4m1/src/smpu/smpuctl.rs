...
///Field `KEY` reader - Key Code This bit is used to enable or disable rewriting of the PROTECT and OAD bit.
pub type KEY_R = crate::FieldReader<KEY_A>;
impl KEY_R {
    ///Get enumerated values variant
    #[inline(always)]
    pub const fn variant(&self) -> KEY_A {
        match self.bits {
            165 => KEY_A::_0X_A5,
            _ => KEY_A::OTHERS,
        }
    ...
    pub fn is_others(&self) -> bool {
        matches!(self.variant(), KEY_A::OTHERS)
    }
}
