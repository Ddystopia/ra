///Register `SMPUSRAM0` reader
pub type R = crate::R<SMPUSRAM0_SPEC>;
///Register `SMPUSRAM0` writer
...
///`read()` method returns [`smpusram0::R`](R) reader structure
impl crate::Readable for SMPUSRAM0_SPEC {}
///`write(|w| ..)` method takes [`smpusram0::W`](W) writer structure
