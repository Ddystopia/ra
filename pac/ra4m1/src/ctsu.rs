...
impl RegisterBlock {
    ...
    ///0x09 - CTSU Channel Enable Control Register 3
    #[inline(always)]
    pub const fn ctsuchac3(&self) -> &CTSUCHAC3 {
        &self.ctsuchac3
    }
    ///0x0a - CTSU Channel Enable Control Register 4
    #[inline(always)]
    ...
    ///0x0d - CTSU Channel Transmit/Receive Control Register 3
    #[inline(always)]
    pub const fn ctsuchtrc2(&self) -> &CTSUCHTRC2 {
        &self.ctsuchtrc2
    }
    ///0x0e - CTSU Channel Transmit/Receive Control Register 3
    #[inline(always)]
    pub const fn ctsuchtrc3(&self) -> &CTSUCHTRC3 {
        &self.ctsuchtrc3
    }
    ///0x0f - CTSU Channel Transmit/Receive Control Register 4
    #[inline(always)]
...
pub mod ctsumch0;
/**CTSUMCH1 (rw) register accessor: CTSU Measurement Channel Register 1
...
pub mod ctsuchac2;
/**CTSUCHAC3 (rw) register accessor: CTSU Channel Enable Control Register 3
...
pub mod ctsuchac3;
/**CTSUCHAC4 (rw) register accessor: CTSU Channel Enable Control Register 4
...
pub mod ctsuchtrc1;
/**CTSUCHTRC2 (rw) register accessor: CTSU Channel Transmit/Receive Control Register 3
...
pub mod ctsuchtrc2;
/**CTSUCHTRC3 (rw) register accessor: CTSU Channel Transmit/Receive Control Register 3
...
///CTSU Channel Transmit/Receive Control Register 3
pub mod ctsuchtrc3;
/**CTSUCHTRC4 (rw) register accessor: CTSU Channel Transmit/Receive Control Register 4
