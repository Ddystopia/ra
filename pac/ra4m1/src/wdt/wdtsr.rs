...
///Field `CNTVAL` reader - Down-Counter Value Value counted by the down-counter
...
impl R {
    ///Bits 0:13 - Down-Counter Value Value counted by the down-counter
    #[inline(always)]
...
impl W {
    ///Bit 14 - Underflow Flag
    #[inline(always)]
    pub fn undff(&mut self) -> UNDFF_W<'_, WDTSR_SPEC> {
        UNDFF_W::new(self, 14)
    }
    ///Bit 15 - Refresh Error Flag
    #[inline(always)]
    pub fn refef(&mut self) -> REFEF_W<'_, WDTSR_SPEC> {
        REFEF_W::new(self, 15)
    }
}
/**WDT Status Register
