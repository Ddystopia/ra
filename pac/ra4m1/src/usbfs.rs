...
impl RegisterBlock {
    ...
    ///0xb0 - BC Control Register 0
    #[inline(always)]
    pub const fn usbbcctrl0(&self) -> &USBBCCTRL0 {
        &self.usbbcctrl0
    }
    ///0xcc - USB Module Control Register
    #[inline(always)]
...
pub mod devadd;
/**USBMC (rw) register accessor: USB Module Control Register
...
pub mod usbmc;
/**USBBCCTRL0 (rw) register accessor: BC Control Register 0
