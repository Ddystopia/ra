...
pub enum OBDTY_A {
    ...
    _01 = 1,
    ///2: GTIOCB pin duty 0 percent
    _10 = 2,
    ///3: GTIOCB pin duty 100 percent
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OBDTYR_A {
    ///0: Apply output value set in 0 percent/100 percent duty to GTIOB\[3:2\] function after releasing 0 percent/100 percent duty setting.
    _0 = 0,
    ///1: Apply masked compare match output value to GTIOB\[3:2\] function after releasing 0 percent/100 percent duty setting.
    _1 = 1,
}
