...
pub enum DSGTRGAR_A {
    ///0: Counter count down is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGAF_A {
    ///0: Counter count down is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGBR_A {
    ///0: Counter count down is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSGTRGBF_A {
    ///0: Counter count down is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCARBL_A {
    ///0: Counter count down is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCARBH_A {
    ///0: Counter count down is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCAFBL_A {
    ///0: Counter count down is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCAFBH_A {
    ///0: Counter count down is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBRAL_A {
    ///0: Counter count down is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBRAH_A {
    ///0: Counter count down is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter count down is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBFAL_A {
    ///0: Counter count down is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSCBFAH_A {
    ///0: Counter count down is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter count down is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCA_A {
    ///0: Counter count down is disable at the ELC_GPTA input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCB_A {
    ///0: Counter count down is disable at the ELC_GPTB input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCC_A {
    ///0: Counter count down is disable at the ELC_GPTC input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCD_A {
    ///0: Counter count down is disable at the ELC_GPTD input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCE_A {
    ///0: Counter count down is disable at the ELC_GPTE input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCF_A {
    ///0: Counter count down is disable at the ELC_GPTF input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCG_A {
    ///0: Counter count down is disable at the ELC_GPTG input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source Counter Count Down Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DSELCH_A {
    ///0: Counter count down is disable at the ELC_GPTH input
    _0 = 0,
    ///1: Counter count down is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `DSELCH` reader - ELCH Event Source Counter Count Down Enable
...
///Field `DSELCH` writer - ELCH Event Source Counter Count Down Enable
...
impl R {
    ...
    ///Bit 23 - ELCH Event Source Counter Count Down Enable
    #[inline(always)]
