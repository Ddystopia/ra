...
pub enum ASGTRGAR_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASGTRGAF_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASGTRGBR_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASGTRGBF_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCARBL_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCARBH_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCAFBL_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCAFBH_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCBRAL_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCBRAH_A {
    ///0: GTCCRA input capture is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: GTCCRA input capture is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCBFAL_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASCBFAH_A {
    ///0: GTCCRA input capture is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: GTCCRA input capture is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCA_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTA input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCB_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTB input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCC_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTC input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCD_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTD input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCE_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTE input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCF_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTF input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCG_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTG input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source GTCCRA Input Capture Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASELCH_A {
    ///0: GTCCRA input capture is disable at the ELC_GPTH input
    _0 = 0,
    ///1: GTCCRA input capture is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `ASELCH` reader - ELCH Event Source GTCCRA Input Capture Enable
...
///Field `ASELCH` writer - ELCH Event Source GTCCRA Input Capture Enable
...
impl R {
    ...
    ///Bit 23 - ELCH Event Source GTCCRA Input Capture Enable
    #[inline(always)]
...
impl W {
    ///Bit 0 - GTETRGA Pin Rising Input Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn asgtrgar(&mut self) -> ASGTRGAR_W<'_, GTICASR_SPEC> {
        ASGTRGAR_W::new(self, 0)
    }
    ///Bit 1 - GTETRGA Pin Falling Input Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn asgtrgaf(&mut self) -> ASGTRGAF_W<'_, GTICASR_SPEC> {
        ASGTRGAF_W::new(self, 1)
    }
    ///Bit 2 - GTETRGB Pin Rising Input Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn asgtrgbr(&mut self) -> ASGTRGBR_W<'_, GTICASR_SPEC> {
        ASGTRGBR_W::new(self, 2)
    }
    ///Bit 3 - GTETRGB Pin Falling Input Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn asgtrgbf(&mut self) -> ASGTRGBF_W<'_, GTICASR_SPEC> {
        ASGTRGBF_W::new(self, 3)
    }
    ///Bit 8 - GTIOCA Pin Rising Input during GTIOCB Value Low Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascarbl(&mut self) -> ASCARBL_W<'_, GTICASR_SPEC> {
        ASCARBL_W::new(self, 8)
    }
    ///Bit 9 - GTIOCA Pin Rising Input during GTIOCB Value High Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascarbh(&mut self) -> ASCARBH_W<'_, GTICASR_SPEC> {
        ASCARBH_W::new(self, 9)
    }
    ///Bit 10 - GTIOCA Pin Falling Input during GTIOCB Value Low Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascafbl(&mut self) -> ASCAFBL_W<'_, GTICASR_SPEC> {
        ASCAFBL_W::new(self, 10)
    }
    ///Bit 11 - GTIOCA Pin Falling Input during GTIOCB Value High Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascafbh(&mut self) -> ASCAFBH_W<'_, GTICASR_SPEC> {
        ASCAFBH_W::new(self, 11)
    }
    ///Bit 12 - GTIOCB Pin Rising Input during GTIOCA Value Low Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascbral(&mut self) -> ASCBRAL_W<'_, GTICASR_SPEC> {
        ASCBRAL_W::new(self, 12)
    }
    ///Bit 13 - GTIOCB Pin Rising Input during GTIOCA Value High Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascbrah(&mut self) -> ASCBRAH_W<'_, GTICASR_SPEC> {
        ASCBRAH_W::new(self, 13)
    }
    ///Bit 14 - GTIOCB Pin Falling Input during GTIOCA Value Low Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascbfal(&mut self) -> ASCBFAL_W<'_, GTICASR_SPEC> {
        ASCBFAL_W::new(self, 14)
    }
    ///Bit 15 - GTIOCB Pin Falling Input during GTIOCA Value High Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn ascbfah(&mut self) -> ASCBFAH_W<'_, GTICASR_SPEC> {
        ASCBFAH_W::new(self, 15)
    }
    ///Bit 16 - ELC_GPTA Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselca(&mut self) -> ASELCA_W<'_, GTICASR_SPEC> {
        ASELCA_W::new(self, 16)
    }
    ///Bit 17 - ELC_GPTB Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselcb(&mut self) -> ASELCB_W<'_, GTICASR_SPEC> {
        ASELCB_W::new(self, 17)
    }
    ///Bit 18 - ELC_GPTC Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselcc(&mut self) -> ASELCC_W<'_, GTICASR_SPEC> {
        ASELCC_W::new(self, 18)
    }
    ///Bit 19 - ELC_GPTD Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselcd(&mut self) -> ASELCD_W<'_, GTICASR_SPEC> {
        ASELCD_W::new(self, 19)
    }
    ///Bit 20 - ELC_GPTE Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselce(&mut self) -> ASELCE_W<'_, GTICASR_SPEC> {
        ASELCE_W::new(self, 20)
    }
    ///Bit 21 - ELC_GPTF Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselcf(&mut self) -> ASELCF_W<'_, GTICASR_SPEC> {
        ASELCF_W::new(self, 21)
    }
    ///Bit 22 - ELC_GPTG Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselcg(&mut self) -> ASELCG_W<'_, GTICASR_SPEC> {
        ASELCG_W::new(self, 22)
    }
    ///Bit 23 - ELCH Event Source GTCCRA Input Capture Enable
    #[inline(always)]
    pub fn aselch(&mut self) -> ASELCH_W<'_, GTICASR_SPEC> {
