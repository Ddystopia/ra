...
pub enum BSGTRGAR_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSGTRGAF_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSGTRGBR_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSGTRGBF_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCARBL_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCARBH_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCAFBL_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCAFBH_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCBRAL_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCBRAH_A {
    ///0: GTCCRB input capture is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: GTCCRB input capture is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCBFAL_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSCBFAH_A {
    ///0: GTCCRB input capture is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: GTCCRB input capture is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCA_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTA input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCB_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTB input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCC_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTC input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCD_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTD input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCE_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTE input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCF_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTF input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCG_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTG input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source GTCCRB Input Capture Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BSELCH_A {
    ///0: GTCCRB input capture is disable at the ELC_GPTH input
    _0 = 0,
    ///1: GTCCRB input capture is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `BSELCH` reader - ELCH Event Source GTCCRB Input Capture Enable
...
///Field `BSELCH` writer - ELCH Event Source GTCCRB Input Capture Enable
