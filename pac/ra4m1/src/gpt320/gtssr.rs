...
pub enum SSGTRGAR_A {
    ///0: Counter start is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGAF_A {
    ///0: Counter start is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGBR_A {
    ///0: Counter start is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSGTRGBF_A {
    ///0: Counter start is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCARBL_A {
    ///0: Counter start is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCARBH_A {
    ///0: Counter start is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCAFBL_A {
    ///0: Counter start is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCAFBH_A {
    ///0: Counter start is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBRAL_A {
    ///0: Counter start is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBRAH_A {
    ///0: Counter start is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter start is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBFAL_A {
    ///0: Counter start is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSCBFAH_A {
    ///0: Counter start is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter start is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCA_A {
    ///0: Counter start is disable at the ELC_GPTA input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCB_A {
    ///0: Counter start is disable at the ELC_GPTB input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCC_A {
    ///0: Counter start is disable at the ELC_GPTC input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCD_A {
    ///0: Counter start is disable at the ELC_GPTD input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCE_A {
    ///0: Counter start is disable at the ELC_GPTE input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCF_A {
    ///0: Counter start is disable at the ELC_GPTF input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCG_A {
    ///0: Counter start is disable at the ELC_GPTG input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source Counter Start Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSELCH_A {
    ///0: Counter start is disable at the ELC_GPTH input
    _0 = 0,
    ///1: Counter start is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `SSELCH` reader - ELCH Event Source Counter Start Enable
...
///Field `SSELCH` writer - ELCH Event Source Counter Start Enable
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSTRT_A {
    ///0: Counter start is disable by the GTSTR register
    _0 = 0,
    ///1: Counter start is enable by the GTSTR register
    _1 = 1,
}
