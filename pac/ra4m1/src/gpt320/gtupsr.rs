...
pub enum USGTRGAR_A {
    ///0: Counter count up is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGAF_A {
    ///0: Counter count up is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGBR_A {
    ///0: Counter count up is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USGTRGBF_A {
    ///0: Counter count up is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCARBL_A {
    ///0: Counter count up is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCARBH_A {
    ///0: Counter count up is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCAFBL_A {
    ///0: Counter count up is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCAFBH_A {
    ///0: Counter count up is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBRAL_A {
    ///0: Counter count up is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBRAH_A {
    ///0: Counter count up is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter count up is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBFAL_A {
    ///0: Counter count up is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USCBFAH_A {
    ///0: Counter count up is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter count up is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCA_A {
    ///0: Counter count up is disable at the ELC_GPTA input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCB_A {
    ///0: Counter count up is disable at the ELC_GPTB input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCC_A {
    ///0: Counter count up is disable at the ELC_GPTC input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCD_A {
    ///0: Counter count up is disable at the ELC_GPTD input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCE_A {
    ///0: Counter count up is disable at the ELC_GPTE input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCF_A {
    ///0: Counter count up is disable at the ELC_GPTF input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCG_A {
    ///0: Counter count up is disable at the ELC_GPTG input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source Counter Count Up Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USELCH_A {
    ///0: Counter count up is disable at the ELC_GPTH input
    _0 = 0,
    ///1: Counter count up is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `USELCH` reader - ELCH Event Source Counter Count Up Enable
...
///Field `USELCH` writer - ELCH Event Source Counter Count Up Enable
...
impl R {
    ...
    ///Bit 23 - ELCH Event Source Counter Count Up Enable
    #[inline(always)]
