...
pub enum PSGTRGAR_A {
    ///0: Counter stop is disable at the rising edge of GTETRGA input
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGAF_A {
    ///0: Counter stop is disable at the falling edge of GTETRGA input
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTETRGA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGBR_A {
    ///0: Counter stop is disable at the rising edge of GTETRGB input
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSGTRGBF_A {
    ///0: Counter stop is disable at the falling edge of GTETRGB input
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTETRGB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCARBL_A {
    ///0: Counter stop is disable at the rising edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCARBH_A {
    ///0: Counter stop is disable at the rising edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCAFBL_A {
    ///0: Counter stop is disable at the falling edge of GTIOCA input when GTIOCB input is 0
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTIOCA input when GTIOCB input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCAFBH_A {
    ///0: Counter stop is disable at the falling edge of GTIOCA input when GTIOCB input is 1
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTIOCA input when GTIOCB input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBRAL_A {
    ///0: Counter stop is disable at the rising edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBRAH_A {
    ///0: Counter stop is disable at the rising edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter stop is enable at the rising edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBFAL_A {
    ///0: Counter stop is disable at the falling edge of GTIOCB input when GTIOCA input is 0
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTIOCB input when GTIOCA input is 0
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSCBFAH_A {
    ///0: Counter stop is disable at the falling edge of GTIOCB input when GTIOCA input is 1
    _0 = 0,
    ///1: Counter stop is enable at the falling edge of GTIOCB input when GTIOCA input is 1
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCA_A {
    ///0: Counter stop is disable at the ELC_GPTA input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTA input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCB_A {
    ///0: Counter stop is disable at the ELC_GPTB input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTB input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCC_A {
    ///0: Counter stop is disable at the ELC_GPTC input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTC input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCD_A {
    ///0: Counter stop is disable at the ELC_GPTD input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTD input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCE_A {
    ///0: Counter stop is disable at the ELC_GPTE input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTE input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCF_A {
    ///0: Counter stop is disable at the ELC_GPTF input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTF input
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCG_A {
    ///0: Counter stop is disable at the ELC_GPTG input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTG input
    _1 = 1,
}
...
/**ELCH Event Source Counter Stop Enable

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PSELCH_A {
    ///0: Counter stop is disable at the ELC_GPTH input
    _0 = 0,
    ///1: Counter stop is enable at the ELC_GPTH input
    _1 = 1,
}
...
///Field `PSELCH` reader - ELCH Event Source Counter Stop Enable
...
///Field `PSELCH` writer - ELCH Event Source Counter Stop Enable
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CSTOP_A {
    ///0: Counter stop is disable by the GTSTP register
    _0 = 0,
    ///1: Counter stop is enable by the GTSTP register
    _1 = 1,
}
