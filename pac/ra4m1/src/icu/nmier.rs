...
///Field `VBATTEN` reader - VBATT monitor Interrupt Enable
...
///Field `VBATTEN` writer - VBATT monitor Interrupt Enable
pub type VBATTEN_W<'a, REG> = crate::BitWriter<'a, REG, VBATTEN_A>;
impl<'a, REG> VBATTEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Disabled
...
///Field `SPEEN` reader - CPU Stack pointer monitor Interrupt Enable
...
///Field `SPEEN` writer - CPU Stack pointer monitor Interrupt Enable
...
impl R {
    ...
    ///Bit 4 - VBATT monitor Interrupt Enable
    #[inline(always)]
    ...
    ///Bit 12 - CPU Stack pointer monitor Interrupt Enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 4 - VBATT monitor Interrupt Enable
    #[inline(always)]
    pub fn vbatten(&mut self) -> VBATTEN_W<'_, NMIER_SPEC> {
        VBATTEN_W::new(self, 4)
    }
    ///Bit 6 - Oscillation Stop Detection Interrupt Enable
    #[inline(always)]
