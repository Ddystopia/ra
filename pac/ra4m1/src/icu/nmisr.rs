...
///Field `VBATTST` reader - VBATT monitor Interrupt Status Flag
...
///Field `SPEST` reader - CPU Stack pointer monitor Interrupt Status Flag
...
impl R {
    ...
    ///Bit 4 - VBATT monitor Interrupt Status Flag
    #[inline(always)]
    ...
    ///Bit 12 - CPU Stack pointer monitor Interrupt Status Flag
    #[inline(always)]
