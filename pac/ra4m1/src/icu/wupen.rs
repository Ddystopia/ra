...
///Field `IRQWUPEN0` reader - IRQ0 interrupt S/W standby returns enable
...
///Field `IRQWUPEN0` writer - IRQ0 interrupt S/W standby returns enable
...
///Field `IRQWUPEN1` reader - IRQ1 interrupt S/W standby returns enable
...
///Field `IRQWUPEN1` writer - IRQ1 interrupt S/W standby returns enable
...
///Field `IRQWUPEN2` reader - IRQ2 interrupt S/W standby returns enable
...
///Field `IRQWUPEN2` writer - IRQ2 interrupt S/W standby returns enable
...
///Field `IRQWUPEN3` reader - IRQ3 interrupt S/W standby returns enable
...
///Field `IRQWUPEN3` writer - IRQ3 interrupt S/W standby returns enable
...
///Field `IRQWUPEN4` reader - IRQ4 interrupt S/W standby returns enable
...
///Field `IRQWUPEN4` writer - IRQ4 interrupt S/W standby returns enable
...
///Field `IRQWUPEN5` reader - IRQ5 interrupt S/W standby returns enable
...
///Field `IRQWUPEN5` writer - IRQ5 interrupt S/W standby returns enable
...
///Field `IRQWUPEN6` reader - IRQ6 interrupt S/W standby returns enable
...
///Field `IRQWUPEN6` writer - IRQ6 interrupt S/W standby returns enable
...
///Field `IRQWUPEN7` reader - IRQ7 interrupt S/W standby returns enable
...
///Field `IRQWUPEN7` writer - IRQ7 interrupt S/W standby returns enable
...
///Field `IRQWUPEN8` reader - IRQ8 interrupt S/W standby returns enable
...
///Field `IRQWUPEN8` writer - IRQ8 interrupt S/W standby returns enable
...
///Field `IRQWUPEN9` reader - IRQ9 interrupt S/W standby returns enable
...
///Field `IRQWUPEN9` writer - IRQ9 interrupt S/W standby returns enable
...
///Field `IRQWUPEN10` reader - IRQ10 interrupt S/W standby returns enable
...
///Field `IRQWUPEN10` writer - IRQ10 interrupt S/W standby returns enable
...
///Field `IRQWUPEN11` reader - IRQ11 interrupt S/W standby returns enable
...
///Field `IRQWUPEN11` writer - IRQ11 interrupt S/W standby returns enable
...
///Field `IRQWUPEN12` reader - IRQ12 interrupt S/W standby returns enable
...
///Field `IRQWUPEN12` writer - IRQ12 interrupt S/W standby returns enable
...
///Field `IRQWUPEN14` reader - IRQ14 interrupt S/W standby returns enable
...
///Field `IRQWUPEN14` writer - IRQ14 interrupt S/W standby returns enable
...
///Field `IRQWUPEN15` reader - IRQ15 interrupt S/W standby returns enable
...
///Field `IRQWUPEN15` writer - IRQ15 interrupt S/W standby returns enable
...
///Field `IWDTWUPEN` reader - IWDT interrupt S/W standby returns enable
...
///Field `IWDTWUPEN` writer - IWDT interrupt S/W standby returns enable
...
///Field `KEYWUPEN` reader - Key interrupt S/W standby returns enable
...
///Field `KEYWUPEN` writer - Key interrupt S/W standby returns enable
...
///Field `LVD1WUPEN` reader - LVD1 interrupt S/W standby returns enable
...
///Field `LVD1WUPEN` writer - LVD1 interrupt S/W standby returns enable
...
///Field `LVD2WUPEN` reader - LVD2 interrupt S/W standby returns enable
...
///Field `LVD2WUPEN` writer - LVD2 interrupt S/W standby returns enable
...
pub enum VBATTWUPEN_A {
    ///0: S/W standby returns by VBATT monitor interrupt is disabled
    _0 = 0,
    ///1: S/W standby returns by VBATT monitor interrupt is enabled
    _1 = 1,
}
...
///Field `VBATTWUPEN` reader - VBATT monitor interrupt S/W standby returns enable
...
///Field `VBATTWUPEN` writer - VBATT monitor interrupt S/W standby returns enable
pub type VBATTWUPEN_W<'a, REG> = crate::BitWriter<'a, REG, VBATTWUPEN_A>;
impl<'a, REG> VBATTWUPEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///S/W standby returns by VBATT monitor interrupt is disabled
...
pub enum ACMPLP0WUPEN_A {
    ///0: S/W standby returns by ACMPLP0 interrupt is disabled
    _0 = 0,
    ///1: S/W standby returns by ACMPLP0 interrupt is enabled
    _1 = 1,
}
...
///Field `ACMPLP0WUPEN` reader - ACMPLP0 interrupt S/W standby returns enable
...
///Field `ACMPLP0WUPEN` writer - ACMPLP0 interrupt S/W standby returns enable
pub type ACMPLP0WUPEN_W<'a, REG> = crate::BitWriter<'a, REG, ACMPLP0WUPEN_A>;
impl<'a, REG> ACMPLP0WUPEN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///S/W standby returns by ACMPLP0 interrupt is disabled
...
///Field `RTCALMWUPEN` reader - RTC alarm interrupt S/W standby returns enable
...
///Field `RTCALMWUPEN` writer - RTC alarm interrupt S/W standby returns enable
...
///Field `RTCPRDWUPEN` reader - RCT period interrupt S/W standby returns enable
...
///Field `RTCPRDWUPEN` writer - RCT period interrupt S/W standby returns enable
...
///Field `USBFSWUPEN` reader - USBFS interrupt S/W standby returns enable
...
///Field `USBFSWUPEN` writer - USBFS interrupt S/W standby returns enable
...
///Field `AGT1UDWUPEN` reader - AGT1 underflow interrupt S/W standby returns enable
...
///Field `AGT1UDWUPEN` writer - AGT1 underflow interrupt S/W standby returns enable
...
///Field `AGT1CAWUPEN` reader - AGT1 compare match A interrupt S/W standby returns enable
...
///Field `AGT1CAWUPEN` writer - AGT1 compare match A interrupt S/W standby returns enable
...
///Field `AGT1CBWUPEN` reader - AGT1 compare match B interrupt S/W standby returns enable
...
///Field `AGT1CBWUPEN` writer - AGT1 compare match B interrupt S/W standby returns enable
...
///Field `IIC0WUPEN` reader - IIC0 address match interrupt S/W standby returns enable
...
///Field `IIC0WUPEN` writer - IIC0 address match interrupt S/W standby returns enable
...
impl W {
    ...
    ///Bit 20 - VBATT monitor interrupt S/W standby returns enable
    #[inline(always)]
    pub fn vbattwupen(&mut self) -> VBATTWUPEN_W<'_, WUPEN_SPEC> {
        VBATTWUPEN_W::new(self, 20)
    }
    ///Bit 23 - ACMPLP0 interrupt S/W standby returns enable
    #[inline(always)]
    pub fn acmplp0wupen(&mut self) -> ACMPLP0WUPEN_W<'_, WUPEN_SPEC> {
        ACMPLP0WUPEN_W::new(self, 23)
    }
    ///Bit 24 - RTC alarm interrupt S/W standby returns enable
    #[inline(always)]
