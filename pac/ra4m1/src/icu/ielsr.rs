...
/**ICU Event selection to NVIC Set the number for the event signal to be linked .
...
///Field `IELS` reader - ICU Event selection to NVIC Set the number for the event signal to be linked .
...
///Field `IELS` writer - ICU Event selection to NVIC Set the number for the event signal to be linked .
pub type IELS_W<'a, REG> = crate::FieldWriter<'a, REG, 8, IELS_A, crate::Safe>;
...
impl R {
    ///Bits 0:7 - ICU Event selection to NVIC Set the number for the event signal to be linked .
    #[inline(always)]
