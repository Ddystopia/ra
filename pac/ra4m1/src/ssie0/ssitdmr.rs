///Register `SSITDMR` reader
pub type R = crate::R<SSITDMR_SPEC>;
///Register `SSITDMR` writer
...
///`read()` method returns [`ssitdmr::R`](R) reader structure
impl crate::Readable for SSITDMR_SPEC {}
///`write(|w| ..)` method takes [`ssitdmr::W`](W) writer structure
impl crate::Writable for SSITDMR_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets SSITDMR to value 0
