...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum GRPABH_A {
    ///0: Same time output level high disable request is disabled.
    _0 = 0,
    ///1: Same time output level high disable request is enabled.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum GRPABL_A {
    ///0: Same time output level low disable request is disabled.
    _0 = 0,
    ///1: Same time output level low disable request is enabled.
    _1 = 1,
}
