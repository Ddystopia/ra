...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OADFLT_A {
    ///0: The GTIOCA pin outputs low when counting is stopped.
    _0 = 0,
    ///1: The GTIOCA pin outputs high when counting is stopped.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OAHLD_A {
    ///0: The GTIOCA pin output level at start/stop of counting depends on the register setting.
    _0 = 0,
    ///1: The GTIOCA pin output level is retained at start/stop of counting.
    _1 = 1,
}
...
pub enum OADF_A {
    ...
    _00 = 0,
    ///1: GTIOCA pin is set to Hi-Z when output disable is performed.
    _01 = 1,
    ///2: GTIOCA pin is set to 0 when output disable is performed.
    _10 = 2,
    ///3: GTIOCA pin is set to 1 when output disable is performed.
    _11 = 3,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OBDFLT_A {
    ///0: The GTIOCB pin outputs low when counting is stopped.
    _0 = 0,
    ///1: The GTIOCB pin outputs high when counting is stopped.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OBHLD_A {
    ///0: The GTIOCB pin output level at start/stop of counting depends on the register setting.
    _0 = 0,
...
pub enum OBDF_A {
    ///0: Output disable is prohibited.
    _00 = 0,
    ///1: GTIOCB pin is set to Hi-Z when output disable is performed.
    _01 = 1,
    ///2: GTIOCB pin is set to 0 when output disable is performed.
    _10 = 2,
    ///3: GTIOCB pin is set to 1 when output disable is performed.
    _11 = 3,
}
