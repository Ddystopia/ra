...
pub enum TDE_A {
    ///0: GTCCRB is set without using GTDVU and GTDVD.
    _0 = 0,
    ///1: GTDVU and GTDVD are used to set the compare match value for negative-phase waveform with dead time automatically in GTCCRB.
    _1 = 1,
}
