...
pub enum MD_A {
    ...
    _011 = 3,
    ///4: Triangle-wave PWM mode 1 (16-bit transfer at crest) (single buffer or double buffer possible)
    _100 = 4,
    ///5: Triangle-wave PWM mode 2 (16-bit transfer at crest and trough) (single buffer or double buffer possible)
    _101 = 5,
    ///6: Triangle-wave PWM mode 3 (32-bit transfer at trough) fixed buffer operation)
    _110 = 6,
