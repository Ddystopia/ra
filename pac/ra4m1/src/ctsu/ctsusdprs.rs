...
///Field `CTSUPRRATIO` reader - CTSU Measurement Time and Pulse Count Adjustment Recommended setting: 3 (0011b)
pub type CTSUPRRATIO_R = crate::FieldReader;
///Field `CTSUPRRATIO` writer - CTSU Measurement Time and Pulse Count Adjustment Recommended setting: 3 (0011b)
...
impl R {
    ///Bits 0:3 - CTSU Measurement Time and Pulse Count Adjustment Recommended setting: 3 (0011b)
    #[inline(always)]
