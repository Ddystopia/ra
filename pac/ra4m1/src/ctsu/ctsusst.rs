...
///Field `CTSUSST` reader - CTSU Sensor Stabilization Wait Control NOTE: The value of these bits should be fixed to 00010000b.
pub type CTSUSST_R = crate::FieldReader;
///Field `CTSUSST` writer - CTSU Sensor Stabilization Wait Control NOTE: The value of these bits should be fixed to 00010000b.
pub type CTSUSST_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    ///Bits 0:7 - CTSU Sensor Stabilization Wait Control NOTE: The value of these bits should be fixed to 00010000b.
    #[inline(always)]
