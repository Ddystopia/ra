...
///Field `CTSUATUNE0` reader - CTSU Power Supply Operating Mode Setting
...
///Field `CTSUATUNE0` writer - CTSU Power Supply Operating Mode Setting
pub type CTSUATUNE0_W<'a, REG> = crate::BitWriter<'a, REG, CTSUATUNE0_A>;
impl<'a, REG> CTSUATUNE0_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Normal operating mode
...
impl R {
    ...
    ///Bit 2 - CTSU Power Supply Operating Mode Setting
    #[inline(always)]
...
impl W {
    ...
    ///Bit 2 - CTSU Power Supply Operating Mode Setting
    #[inline(always)]
    pub fn ctsuatune0(&mut self) -> CTSUATUNE0_W<'_, CTSUCR1_SPEC> {
        CTSUATUNE0_W::new(self, 2)
    }
    ///Bit 3 - CTSU Power Supply Capacity Adjustment
    #[inline(always)]
