...
///Field `CTSUSSMOD` reader - CTSU Diffusion Clock Mode Select NOTE: This bit should be set to 00b.
pub type CTSUSSMOD_R = crate::FieldReader;
///Field `CTSUSSMOD` writer - CTSU Diffusion Clock Mode Select NOTE: This bit should be set to 00b.
pub type CTSUSSMOD_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
///Field `CTSUSSCNT` reader - CTSU Diffusion Clock Mode Control NOTE: This bit should be set to 11b.
pub type CTSUSSCNT_R = crate::FieldReader;
///Field `CTSUSSCNT` writer - CTSU Diffusion Clock Mode Control NOTE: This bit should be set to 11b.
pub type CTSUSSCNT_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    ///Bits 0:1 - CTSU Diffusion Clock Mode Select NOTE: This bit should be set to 00b.
    #[inline(always)]
    pub fn ctsussmod(&self) -> CTSUSSMOD_R {
        CTSUSSMOD_R::new(self.bits & 3)
    }
    ///Bits 4:5 - CTSU Diffusion Clock Mode Control NOTE: This bit should be set to 11b.
    #[inline(always)]
