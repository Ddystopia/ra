...
/**Main Clock Oscillator Stop Note: MOMCR register must be set before setting MOSTP to 0.
...
///Field `MOSTP` reader - Main Clock Oscillator Stop Note: MOMCR register must be set before setting MOSTP to 0.
...
///Field `MOSTP` writer - Main Clock Oscillator Stop Note: MOMCR register must be set before setting MOSTP to 0.
...
impl R {
    ///Bit 0 - Main Clock Oscillator Stop Note: MOMCR register must be set before setting MOSTP to 0.
    #[inline(always)]
