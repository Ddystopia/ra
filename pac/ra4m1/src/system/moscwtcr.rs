...
#[repr(u8)]
pub enum MSTS_A {
    ///0: Wait time = 2 cycles (0.25 us)
    _0000 = 0,
    ///1: Wait time = 1024 cycles (128 us)
    _0001 = 1,
    ///2: Wait time = 2048 cycles (256 us)
    _0010 = 2,
    ///3: Wait time = 4096 cycles (512 us)
    _0011 = 3,
    ///4: Wait time = 8192 cycles (1024 us)
    _0100 = 4,
    ///5: Wait time = 16384 cycles (2048 us) (value after reset)
    _0101 = 5,
    ///6: Wait time = 32768 cycles (4096 us)
    _0110 = 6,
    ///7: Wait time = 65536 cycles (8192 us)
    _0111 = 7,
    ///8: Wait time = 131072 cycles (16384 us)
    _1000 = 8,
    ///9: Wait time = 262144 cycles (32768 us).
    _1001 = 9,
