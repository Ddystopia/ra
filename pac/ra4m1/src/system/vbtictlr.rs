...
///Field `VCH0INEN` reader - VBATT Wakeup I/O 0 Input Enable
...
///Field `VCH0INEN` writer - VBATT Wakeup I/O 0 Input Enable
...
///Field `VCH1INEN` reader - VBATT Wakeup I/O 1 Input Enable
...
///Field `VCH1INEN` writer - VBATT Wakeup I/O 1 Input Enable
...
///Field `VCH2INEN` reader - VBATT Wakeup I/O 2 Input Enable
...
///Field `VCH2INEN` writer - VBATT Wakeup I/O 2 Input Enable
