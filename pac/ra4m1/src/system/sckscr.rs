...
///Field `CKSEL` reader - Clock Source Select Selecting the system clock source faster than 32MHz(system clock source > 32MHz ) is prohibit when SCKDIVCR.ICK\[2:0\] bits select the division-by-1 and MEMWAIT.MEMWAIT =0.
...
///Field `CKSEL` writer - Clock Source Select Selecting the system clock source faster than 32MHz(system clock source > 32MHz ) is prohibit when SCKDIVCR.ICK\[2:0\] bits select the division-by-1 and MEMWAIT.MEMWAIT =0.
...
impl R {
    ///Bits 0:2 - Clock Source Select Selecting the system clock source faster than 32MHz(system clock source > 32MHz ) is prohibit when SCKDIVCR.ICK\[2:0\] bits select the division-by-1 and MEMWAIT.MEMWAIT =0.
    #[inline(always)]
