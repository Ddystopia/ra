...
/**Cold/Warm Start Determination Flag Note: Only 1 can be written to set the flag.
...
/**Field `CWSF` reader - Cold/Warm Start Determination Flag Note: Only 1 can be written to set the flag.
...
///Field `CWSF` writer - Cold/Warm Start Determination Flag Note: Only 1 can be written to set the flag.
...
impl R {
    ///Bit 0 - Cold/Warm Start Determination Flag Note: Only 1 can be written to set the flag.
    #[inline(always)]
