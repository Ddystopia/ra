...
///Field `DOPCF` reader - Data Operation Circuit Flag Indicates the result of an operation.
...
impl R {
    ...
    ///Bit 5 - Data Operation Circuit Flag Indicates the result of an operation.
    #[inline(always)]
