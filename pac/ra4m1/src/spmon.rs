...
impl RegisterBlock {
    ...
    ///0x08 - Main Stack Pointer (MSP) Monitor Start Address Register
    #[inline(always)]
    pub const fn mspmpusa(&self) -> &MSPMPUSA {
        &self.mspmpusa
    }
    ///0x0c - Main Stack Pointer (MSP) Monitor End Address Register
    #[inline(always)]
    ...
    ///0x18 - Process Stack Pointer (PSP) Monitor Start Address Register
    #[inline(always)]
    pub const fn pspmpusa(&self) -> &PSPMPUSA {
        &self.pspmpusa
    }
    ///0x1c - Process Stack Pointer (PSP) Monitor End Address Register
    #[inline(always)]
...
pub mod mspmpupt;
/**MSPMPUSA (rw) register accessor: Main Stack Pointer (MSP) Monitor Start Address Register
...
pub mod mspmpusa;
/**MSPMPUEA (rw) register accessor: Main Stack Pointer (MSP) Monitor End Address Register
...
///Stack Pointer Monitor Protection Register
pub mod pspmpupt;
/**PSPMPUSA (rw) register accessor: Process Stack Pointer (PSP) Monitor Start Address Register
...
pub mod pspmpusa;
/**PSPMPUEA (rw) register accessor: Process Stack Pointer (PSP) Monitor End Address Register
