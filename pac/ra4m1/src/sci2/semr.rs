...
/**Asynchronous Mode Extended Base Clock Select 1 (Valid only in asynchronous mode and SCR.CKE\[1\]=0)
...
///Field `ABCSE` reader - Asynchronous Mode Extended Base Clock Select 1 (Valid only in asynchronous mode and SCR.CKE\[1\]=0)
...
///Field `ABCSE` writer - Asynchronous Mode Extended Base Clock Select 1 (Valid only in asynchronous mode and SCR.CKE\[1\]=0)
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NFEN_A {
    ///0: Noise cancellation function for the RXDn/SSCLn and SSDAn input signal is disabled.
    _0 = 0,
    ///1: Noise cancellation function for the RXDn/SSCLn and SSDAn input signal is enabled.
    _1 = 1,
}
...
impl R {
    ...
    ///Bit 3 - Asynchronous Mode Extended Base Clock Select 1 (Valid only in asynchronous mode and SCR.CKE\[1\]=0)
    #[inline(always)]
