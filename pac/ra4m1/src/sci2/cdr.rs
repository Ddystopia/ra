...
///Field `CMPD` reader - Compare Match Data Compare data pattern for address match wake-up function
pub type CMPD_R = crate::FieldReader<u16>;
///Field `CMPD` writer - Compare Match Data Compare data pattern for address match wake-up function
