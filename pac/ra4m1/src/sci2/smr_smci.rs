...
///Field `BCP` reader - Base Clock Pulse (Valid only in asynchronous mode)
...
///Field `BCP` writer - Base Clock Pulse (Valid only in asynchronous mode)
...
impl R {
    ...
    ///Bits 2:3 - Base Clock Pulse (Valid only in asynchronous mode)
    #[inline(always)]
