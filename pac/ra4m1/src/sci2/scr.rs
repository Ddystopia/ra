...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TEIE_A {
    ///0: SCI_TEI interrupt request is disabled
    _0 = 0,
    ///1: SCI_TEI interrupt request is enabled
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIE_A {
    ///0: SCI_TXI interrupt request is disabled
    _0 = 0,
    ///1: SCI_TXI interrupt request is enabled
    _1 = 1,
}
