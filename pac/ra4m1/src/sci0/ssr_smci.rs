...
///Field `MPBT` reader - Multi-Processor Bit Transfer This bit should be 0 in smart card interface mode.
pub type MPBT_R = crate::BitReader;
///Field `MPBT` writer - Multi-Processor Bit Transfer This bit should be 0 in smart card interface mode.
pub type MPBT_W<'a, REG> = crate::BitWriter<'a, REG>;
///Field `MPB` reader - Multi-Processor This bit should be 0 in smart card interface mode.
...
impl R {
    ///Bit 0 - Multi-Processor Bit Transfer This bit should be 0 in smart card interface mode.
    #[inline(always)]
    pub fn mpbt(&self) -> MPBT_R {
        MPBT_R::new((self.bits & 1) != 0)
    }
    ///Bit 1 - Multi-Processor This bit should be 0 in smart card interface mode.
    #[inline(always)]
