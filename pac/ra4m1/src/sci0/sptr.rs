...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPB2DT_A {
    ///0: Low level is output on TXD pin
    _0 = 0,
    ///1: High level is output on TXD pin
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPB2IO_A {
    ///0: The value of SPB2DT bit is not output in TXD pin.
    _0 = 0,
    ///1: The value of SPB2DT bit is output in TXD pin.
    _1 = 1,
}
