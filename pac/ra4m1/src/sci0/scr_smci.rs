...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RIE_A {
    ///0: SCI_RXI and SCI_ERI interrupt requests are disabled
    _0 = 0,
    ///1: SCI_RXI and SCI_ERI interrupt requests are enabled
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIE_A {
    ///0: A SCI_TXI interrupt request is disabled
    _0 = 0,
    ///1: A SCI_TXI interrupt request is enabled
    _1 = 1,
}
...
impl W {
    ///Bits 0:1 - Clock Enable
    #[inline(always)]
    pub fn cke(&mut self) -> CKE_W<'_, SCR_SMCI_SPEC> {
        CKE_W::new(self, 0)
    }
    ///Bit 2 - Transmit End Interrupt Enable
    #[inline(always)]
    pub fn teie(&mut self) -> TEIE_W<'_, SCR_SMCI_SPEC> {
        TEIE_W::new(self, 2)
    }
    ///Bit 3 - Multi-Processor Interrupt Enable
    #[inline(always)]
    pub fn mpie(&mut self) -> MPIE_W<'_, SCR_SMCI_SPEC> {
        MPIE_W::new(self, 3)
    }
    ///Bit 4 - Receive Enable
    #[inline(always)]
    pub fn re(&mut self) -> RE_W<'_, SCR_SMCI_SPEC> {
        RE_W::new(self, 4)
    }
    ///Bit 5 - Transmit Enable
    #[inline(always)]
    pub fn te(&mut self) -> TE_W<'_, SCR_SMCI_SPEC> {
        TE_W::new(self, 5)
    }
    ///Bit 6 - Receive Interrupt Enable
    #[inline(always)]
    pub fn rie(&mut self) -> RIE_W<'_, SCR_SMCI_SPEC> {
        RIE_W::new(self, 6)
    }
    ///Bit 7 - Transmit Interrupt Enable
    #[inline(always)]
    pub fn tie(&mut self) -> TIE_W<'_, SCR_SMCI_SPEC> {
        TIE_W::new(self, 7)
    }
}
