...
///Field `CRCSA` reader - snoop address bit Set the I/O register address to snoop
...
///Field `CRCSA` writer - snoop address bit Set the I/O register address to snoop
...
impl R {
    ///Bits 0:13 - snoop address bit Set the I/O register address to snoop
    #[inline(always)]
