...
#[repr(u8)]
pub enum SEL_A {
    ///0: Select the AGTIOn except for below pins
    _00 = 0,
    ///1: Setting prohibited
    _01 = 1,
    ///2: Select the P402/AGTIOn. P402/AGTIOn is input only. It is not possible to output
    _10 = 2,
    ///3: Select the P403/AGTIOn. P403/AGTIOn is input only. It is not possible to output
    _11 = 3,
}
