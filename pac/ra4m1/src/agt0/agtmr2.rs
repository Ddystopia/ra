...
///Field `CKS` reader - AGTLCLK/AGTSCLK count source clock frequency division ratio
...
///Field `CKS` writer - AGTLCLK/AGTSCLK count source clock frequency division ratio
