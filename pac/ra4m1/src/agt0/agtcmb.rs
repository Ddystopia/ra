...
///Field `AGTCMB` reader - AGT Compare Match B data is stored. NOTE : When 1 is written to the TSTOP bit in the AGTCR register, set to FFFFH
pub type AGTCMB_R = crate::FieldReader<u16>;
///Field `AGTCMB` writer - AGT Compare Match B data is stored. NOTE : When 1 is written to the TSTOP bit in the AGTCR register, set to FFFFH
