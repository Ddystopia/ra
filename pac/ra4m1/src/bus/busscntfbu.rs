///Register `BUSSCNTFBU` reader
pub type R = crate::R<BUSSCNTFBU_SPEC>;
///Register `BUSSCNTFBU` writer
...
///`read()` method returns [`busscntfbu::R`](R) reader structure
impl crate::Readable for BUSSCNTFBU_SPEC {}
///`write(|w| ..)` method takes [`busscntfbu::W`](W) writer structure
