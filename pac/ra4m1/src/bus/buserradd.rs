...
///Field `BERAD` reader - Bus Error Address When a bus error occurs, It stores an error address.
pub type BERAD_R = crate::FieldReader<u32>;
impl R {
    ///Bits 0:31 - Bus Error Address When a bus error occurs, It stores an error address.
    #[inline(always)]
