...
impl RegisterBlock {
    ...
    ///0x8a - A/D High-Potential/Low-Potential Reference Voltage Control Register
    #[inline(always)]
    ...
    ///0xe0..0xef - A/D Sampling State Register %s
    #[inline(always)]
...
pub mod addbldrb;
/**ADHVREFCNT (rw) register accessor: A/D High-Potential/Low-Potential Reference Voltage Control Register
...
pub mod adsstro;
/**ADSSTR (rw) register accessor: A/D Sampling State Register %s
