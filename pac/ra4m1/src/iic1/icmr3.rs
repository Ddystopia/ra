...
///Field `WAIT` reader - WAIT Note: When the value of the WAIT bit is to be read, be sure to read the ICDRR beforehand.
...
///Field `WAIT` writer - WAIT Note: When the value of the WAIT bit is to be read, be sure to read the ICDRR beforehand.
...
impl R {
    ...
    ///Bit 6 - WAIT Note: When the value of the WAIT bit is to be read, be sure to read the ICDRR beforehand.
    #[inline(always)]
