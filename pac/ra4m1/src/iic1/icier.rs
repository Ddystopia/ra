...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RIE_A {
    ///0: Receive data full interrupt request (IIC_RXI) is disabled.
    _0 = 0,
    ///1: Receive data full interrupt request (IIC_RXI) is enabled.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TEIE_A {
    ///0: Transmit end interrupt request (IIC_TEI) is disabled.
    _0 = 0,
    ///1: Transmit end interrupt request (IIC_TEI) is enabled.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TIE_A {
    ///0: Transmit data empty interrupt request (IIC_TXI) is disabled.
    _0 = 0,
    ///1: Transmit data empty interrupt request (IIC_TXI) is enabled.
    _1 = 1,
}
