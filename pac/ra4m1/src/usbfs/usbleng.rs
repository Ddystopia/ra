...
///Field `WLENTUH` reader - Length These bits store the USB request wLength value.
pub type WLENTUH_R = crate::FieldReader<u16>;
///Field `WLENTUH` writer - Length These bits store the USB request wLength value.
pub type WLENTUH_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
