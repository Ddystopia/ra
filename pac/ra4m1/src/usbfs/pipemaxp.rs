...
///Field `MXPS` reader - Maximum Packet Size PIPE1 and PIPE2: 1 byte (001h) to 256 bytes (100h) PIPE3 to PIPE5: 8 bytes (008h), 16 bytes (010h), 32 bytes (020h), 64 bytes (040h) (Bits \[8:7\] and \[2:0\] are not provided.) PIPE6 to PIPE9: 1 byte (001h) to 64 bytes (040h) (Bits \[8:7\] are not provided.)
pub type MXPS_R = crate::FieldReader<u16>;
///Field `MXPS` writer - Maximum Packet Size PIPE1 and PIPE2: 1 byte (001h) to 256 bytes (100h) PIPE3 to PIPE5: 8 bytes (008h), 16 bytes (010h), 32 bytes (020h), 64 bytes (040h) (Bits \[8:7\] and \[2:0\] are not provided.) PIPE6 to PIPE9: 1 byte (001h) to 64 bytes (040h) (Bits \[8:7\] are not provided.)
