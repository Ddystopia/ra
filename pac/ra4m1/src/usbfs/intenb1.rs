...
///Field `PDDETINTE0` reader - PDDETINT0 Detection Interrupt Enable
...
///Field `PDDETINTE0` writer - PDDETINT0 Detection Interrupt Enable
pub type PDDETINTE0_W<'a, REG> = crate::BitWriter<'a, REG, PDDETINTE0_A>;
impl<'a, REG> PDDETINTE0_W<'a, REG>
where
...
impl R {
    ///Bit 0 - PDDETINT0 Detection Interrupt Enable
    #[inline(always)]
...
impl W {
    ///Bit 0 - PDDETINT0 Detection Interrupt Enable
    #[inline(always)]
    pub fn pddetinte0(&mut self) -> PDDETINTE0_W<'_, INTENB1_SPEC> {
        PDDETINTE0_W::new(self, 0)
    }
    ///Bit 4 - Setup Transaction Normal Response Interrupt Enable
    #[inline(always)]
