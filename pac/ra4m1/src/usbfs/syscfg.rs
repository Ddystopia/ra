...
///Field `DMRPU` reader - D- Line Resistor Control
...
///Field `DMRPU` writer - D- Line Resistor Control
pub type DMRPU_W<'a, REG> = crate::BitWriter<'a, REG, DMRPU_A>;
impl<'a, REG> DMRPU_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Line pull-up disabled
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CNEN_A {
    ///0: Single end receiver disabled
    _0 = 0,
    ///1: Single end receiver enabled
    _1 = 1,
}
...
///Field `CNEN` reader - CNEN Single End Receiver Enable
...
///Field `CNEN` writer - CNEN Single End Receiver Enable
...
impl R {
    ...
    ///Bit 8 - CNEN Single End Receiver Enable
    #[inline(always)]
...
impl W {
    ...
    ///Bit 3 - D- Line Resistor Control
    #[inline(always)]
    pub fn dmrpu(&mut self) -> DMRPU_W<'_, SYSCFG_SPEC> {
        DMRPU_W::new(self, 3)
    }
    ///Bit 4 - D+ Line Resistor Control
    #[inline(always)]
