...
pub enum LNST_A {
    ///0: SE0
    _00 = 0,
    ///1: K-State (FS) / J-State(LS)
    _01 = 1,
    ///2: J-State(FS) / K-State(LS)
    _10 = 2,
    ///3: SE1
    _11 = 3,
}
...
///Field `OVCMON` reader - External USB0_OVRCURA/ USB0_OVRCURB Input Pin Monitor The OCVMON\[1\] bit indicates the status of the USBHS_OVRCURA pin. The OCVMON\[0\] bit indicates the status of the USBHS_OVRCURB pin.
...
impl R {
    ...
    ///Bits 14:15 - External USB0_OVRCURA/ USB0_OVRCURB Input Pin Monitor The OCVMON\[1\] bit indicates the status of the USBHS_OVRCURA pin. The OCVMON\[0\] bit indicates the status of the USBHS_OVRCURB pin.
    #[inline(always)]
