...
/**Field `PDDETINT0` reader - PDDET0 Detection Interrupt Status
...
///Field `PDDETINT0` writer - PDDET0 Detection Interrupt Status
pub type PDDETINT0_W<'a, REG> = crate::BitWriter0C<'a, REG, PDDETINT0_A>;
impl<'a, REG> PDDETINT0_W<'a, REG>
where
...
impl R {
    ///Bit 0 - PDDET0 Detection Interrupt Status
    #[inline(always)]
...
impl W {
    ///Bit 0 - PDDET0 Detection Interrupt Status
    #[inline(always)]
    pub fn pddetint0(&mut self) -> PDDETINT0_W<'_, INTSTS1_SPEC> {
        PDDETINT0_W::new(self, 0)
    }
    ///Bit 4 - Setup Transaction Normal Response Interrupt Status
    #[inline(always)]
