...
/**Window A/B Composite Conditions Setting NOTE: These bits are valid when both window A and window B are enabled (CMPAE = 1 and CMPBE = 1).

Value on reset: 0*/
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CMPAB_A {
    ///0: ADC140_WCMPM is output when window A comparison conditions are met OR window B comparison conditions are met. ADC140_WCMPUM is output in other cases.
    _00 = 0,
    ///1: S14ADWMELC0 is output when window A comparison conditions are met EXOR window B comparison conditions are met. ADC140_WCMPUM is output in other cases.
    _01 = 1,
    ///2: ADC140_WCMPM is output when window A comparison conditions are met and window B comparison conditions are met. ADC140_WCMPUM is output in other cases.
    _10 = 2,
...
///Field `CMPAB` reader - Window A/B Composite Conditions Setting NOTE: These bits are valid when both window A and window B are enabled (CMPAE = 1 and CMPBE = 1).
...
///Field `CMPAB` writer - Window A/B Composite Conditions Setting NOTE: These bits are valid when both window A and window B are enabled (CMPAE = 1 and CMPBE = 1).
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPBE_A {
    ///0: Compare window B operation is disabled. ADC140_WCMPM and ADC140_WCMPUM outputs are disabled.
    _0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPAE_A {
    ///0: Compare window A operation is disabled. ADC140_WCMPM and ADC140_WCMPUM outputs are disabled.
    _0 = 0,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPBIE_A {
    ///0: ADC140_CMPAI interrupt is disabled when comparison conditions (window B) are met.
    _0 = 0,
    ///1: ADC140_CMPAI interrupt is enabled when comparison conditions (window B) are met.
    _1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CMPAIE_A {
    ///0: ADC140_CMPAI interrupt is disabled when comparison conditions (window A) are met.
    _0 = 0,
    ///1: ADC140_CMPAI interrupt is enabled when comparison conditions (window A) are met.
    _1 = 1,
}
