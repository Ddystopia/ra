...
///Field `PCHG` reader - Selection of Precharge or Discharge
...
///Field `PCHG` writer - Selection of Precharge or Discharge
pub type PCHG_W<'a, REG> = crate::BitWriter<'a, REG, PCHG_A>;
impl<'a, REG> PCHG_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ///Discharge
