...
///Field `AD` reader - A/D-converted value (right-justified) The format for data determine ADCER.ADRFMT and ADCER.ADPRC.
...
impl R {
    ///Bits 0:13 - A/D-converted value (right-justified) The format for data determine ADCER.ADRFMT and ADCER.ADPRC.
    #[inline(always)]
    pub fn ad(&self) -> AD_R {
