...
pub enum ADPRC_A {
    ...
    _00 = 0,
    ///3: A/D conversion is performed with 14-bit accuracy.
    _11 = 3,
...
impl ADPRC_R {
    ...
    pub fn is_others(&self) -> bool {
        matches!(self.variant(), ADPRC_A::OTHERS)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DIAGM_A {
    ///0: Disables self-diagnosis of A/D converter.
    _0 = 0,
