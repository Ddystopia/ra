///Register `P108PFS` reader
pub type R = crate::R<P108PFS_SPEC>;
///Register `P108PFS` writer
...
///`read()` method returns [`p108pfs::R`](R) reader structure
impl crate::Readable for P108PFS_SPEC {}
///`write(|w| ..)` method takes [`p108pfs::W`](W) writer structure
impl crate::Writable for P108PFS_SPEC {
    type Safety = crate::Unsafe;
}
///`reset()` method sets P108PFS to value 0x0001_0010
