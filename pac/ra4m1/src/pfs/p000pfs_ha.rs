///Register `P000PFS_HA` reader
pub type R = crate::R<P000PFS_HA_SPEC>;
///Register `P000PFS_HA` writer
...
///`read()` method returns [`p000pfs_ha::R`](R) reader structure
impl crate::Readable for P000PFS_HA_SPEC {}
///`write(|w| ..)` method takes [`p000pfs_ha::W`](W) writer structure
